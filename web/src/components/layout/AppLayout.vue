...
const ICONS = {
  ...
  quotes:     'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9l2 2 4-4',
  ...
  const sections: NavSection[] = [
    { items: [{ to: '/', label: t('nav.dashboard'), icon: ICONS.dashboard }] },
    {
      ...
      items: [
        ...
        { to: '/quotes',           label: t('nav.quotes'),     icon: ICONS.quotes,    newTo: '/quotes/new' },
