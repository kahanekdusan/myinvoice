...
| `docker-migrate-project-data.ps1` | Přenese data mezi Docker project volumes (db-data + app-data), např. ze starého `myinvoice_dev` do nového `myinvoice`; umí i backup cílových volumes před přepisem |
